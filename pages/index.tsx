            ...
            <div className={styles.gridlayout}>
                <div className={styles.intro}>
                    ...
                    <Typography variant="body1" paragraph>
                        ...
                        be as close as possible to HX and HY
                    </Typography>
                    <Typography variant="body1" paragraph>
                        Or you can just use the sliders as a simple stem
                        calculator.
                    </Typography>
                    <Typography variant="body1" paragraph>
...
function Fit() {
    ...
    const stackMessage = () => {
        ...
        const diffNote =
            diff !== 0 ? (diff < 0 ? "TOO TALL" : "TOO SHORT") : "JUST RIGHT";
    ...
    const reachMessage = () => {
        ...
        const diffNote =
            diff !== 0 ? (diff < 0 ? "TOO LONG" : "TOO SHORT") : "JUST RIGHT";
        return diffNote === "JUST RIGHT"
            ? `Reach is ${diffNote}`
    ...
    return (
        inurl && (
            <>
                <title>{`${
                    state.name ?? ""
                } Bicycle Stem & Fit Calculator`}</title>
                <div className="name">
                    ...
                    <div id="name">
                        <TextField
                            ...
                            style={{ width: 421 }}
                            helperText={
                                inputError === "name" ? "That's too long" : ""
                            }
                        />
                    </div>
                </div>
                ...
                <div className={styles.sliderContainer}>
                    ...
                    <div className={styles.slider}>
                        <Slider
                            name="angleStem"
                            disabled={Boolean(
                                inputError && inputError !== "angleStem"
                            )}
                            min={-60}
                            max={60}
                ...
                <div className={styles.drawing}>
                    ...
                    >
                        ...
                        <line
                            ...
                            x2={
                                (topOfHTX -
                                    Math.cos(getRadians(stemAngle)) *
                                        state.stem) /
                                SHRINK_FACTOR
                            }
                            y2={
                                (topOfHTY -
                                    Math.sin(getRadians(stemAngle)) *
                                        state.stem) /
                                SHRINK_FACTOR
                            }
                            stroke="blue"
